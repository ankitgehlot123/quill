angular.module('reg')
    ...
    .constant('DASHBOARD', {
        ...
        DECLINED: 'We\'re sorry to hear that you won\'t be able to make it to RECKON-jiet 2018 ! :(\nMaybe next year! We hope you see you again soon.',
    })
    .constant('TEAM',{
        NO_TEAM_REG_CLOSED: 'Unfortunately, it\'s too lateto choose your team online.\nHowever, you can still form teams on your own before or during the event!',
    });
